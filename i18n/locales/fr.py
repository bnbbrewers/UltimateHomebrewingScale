...
TRANSLATIONS = {
    ...
    'portal': {
        ...
        'backup_title': 'Sauvegarde / restauration de la configuration',
        'backup_download': 'Sauvegarder',
        'backup_file': 'Fichier de sauvegarde',
        'backup_restore': 'Restaurer',
        'backup_restored': 'Configuration restaurée. Redémarrage...',
        'backup_restore_failed': 'Échec de la restauration : {0}',
        'forbidden': 'Interdit',
