...
TRANSLATIONS = {
    ...
    'updater': {
        ...
        'searching_version': 'Recherche d une nouvelle version ...',
        'downloading_manifest': 'Telechargement manifest',
        'downloading_archive': 'Telechargement archive',
    ...
    'portal': {
        ...
        'backup_download': 'TELECHARGER LA SAUVEGARDE',
        'backup_restore': 'RESTAURER ET REDEMARRER',
        'backup_paste': 'Coller ici un fichier de sauvegarde',
        'backup_restored': 'Configuration restauree. Redemarrage...',
        'backup_restore_failed': 'Restauration echouee : {0}',
        'forbidden': 'Interdit',
        ...
        'fields': {
            ...
            'STANDBY_TIMEOUT_MIN': 'Veille après (min, 0 = désactivé)',
