...
TRANSLATIONS = {
    ...
    'updater': {
        ...
        'searching_version': 'Searching for a new version...',
        'downloading_manifest': 'Downloading manifest',
        'downloading_archive': 'Downloading update archive',
    ...
    'portal': {
        ...
        'backup_restore': 'RESTORE AND REBOOT',
        'backup_paste': 'Paste a backup file here',
        'backup_restored': 'Configuration restored. Rebooting...',
