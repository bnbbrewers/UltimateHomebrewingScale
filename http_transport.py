...
This module deliberately lives at the repository root.  Importing
``core.http_client`` would execute ``core/__init__.py`` and load the LVGL
runtime, which is exactly what the updater must avoid at boot.
"""
